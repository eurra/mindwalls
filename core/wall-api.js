...
/*let emptyWall = {
	...
	getUpperWall: () => this,
	getBottomWall: () => this,
	moveToParentBrick: () => this,
	moveToFirstChildBrick: () => this,
	moveToNextSiblingBrick: () => this,
	moveToPrevSiblingBrick: () => this
};

function getWallOf(elem) {
...
function Wall() {
	let ui = $('<div class="wall">').data('wall-data', this);
	let mainBrick = bricks.empty;
	let isActive = false;
